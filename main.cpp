...
//The driver function for Nitrox where the user can interface with the application and do various pre-defined functions
//Not a complete resembleance of Nitrox
int main()
{
	int input1;
	int input2;
